  ...
  try {
    ...
    if (db_medium.width !== undefined) {
      return response.send({
        _medium: await shorten(db_medium.url),
        _low: await shorten(db_low.url),
        _lowest: await shorten(db_ultralow.url),
      });
    } else if (db_medium.width === undefined && db_low.width !== undefined) {
      return response.send({
        _medium: await shorten(undefined),
        _low: await shorten(db_low.url),
        _lowest: await shorten(db_ultralow.url),
      });
    } else if (
...
// ===========================================================================================================
// http://localhost:4000/audio?q=https://youtu.be/8M6PhD0v9TE
// http://localhost:4000/video?q=https://youtu.be/8M6PhD0v9TE
