...
return `https://tz2k7x-33073.preview.csb.app/audio?q=${audio}&title=${title}`;
}
function getVideo(video: any, audio: any, title: any) {
return `https://tz2k7x-33073.preview.csb.app/video?q=?video=${video}&audio=${audio}&title=${title}`;
}
...
var _vdata = await axios.get(`https://tz2k7x-33073.preview.csb.app/video?q=` + _data.data._Url);
var _adata = await axios.get(`https://tz2k7x-33073.preview.csb.app/audio?q=` + _data.data._Url);
var _mudata = await axios.get(`https://tz2k7x-33073.preview.csb.app/music?q=` + _data.data._Url);
