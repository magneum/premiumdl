...
var _vdata = await axios.get(`https://kopthv-4000.preview.csb.app/video?q=` + _data.data._Url);
var _adata = await axios.get(`https://kopthv-4000.preview.csb.app/audio?q=` + _data.data._Url);
var _mudata = await axios.get(`https://kopthv-4000.preview.csb.app/music?q=` + _data.data._Url);
