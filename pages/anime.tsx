...
var crons = await axios.get(`/api/anime?title=${userInput.current.value}`);
...
return (
<div className="bg-[#131313] text-white h-screen snap-y snap-mandatory overflow-scroll z-0">
