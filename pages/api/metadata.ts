...
try {
let _ALINK: any;
let _userIO = response.query.q as string;
var _MDATA = await axios.get( "https://magneum.vercel.app/api/youtube_sr?q=" + _userIO );
...
(vos: any) =>
vos.format_id === "139" || vos.format_id === "249" || vos.format_id === "250"
);
...
(vos: any) =>
vos.format_id === "399" || vos.format_id === "137" || vos.format_id === "248"
);
...
(vos: any) =>
vos.format_id === "397" || vos.format_id === "135" || vos.format_id === "244"
);
...
(vos: any) =>
vos.format_id === "395" || vos.format_id === "133" || vos.format_id === "242"
);
